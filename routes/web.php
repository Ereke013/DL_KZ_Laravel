...
Route::get('/myMark', function (){
    ...
    return view('myMark', ['ttt'=>$teach, 'grLes'=>$gr_lesson, 'teachers'=>Teachers::all(), 'subjects'=>Subjects::all(), 'teaches'=>Teach::all(),'groups'=>Groups::all(),'groupSubj'=>GroupLesson::all()]);
})->name('myMark');
...
//<- End Group lesson ->
    ...
    Route::get('/users', [UserController::class,'allData'])->name('users');

    Route::get('/users/{id}/edit', [UserController::class, 'grLessonsEdit'])->name('group_lessons-edit');

    Route::get('/reg', function (){
        return view('auth.register');
    })->name('reg');

    Route::post('/registration',[ UserController::class, 'addUserForm'])->name('registr');
});

//Route::post('/logoutFormPage', function (){
//    session()->flush();
//    return redirect()->route('home');
//})->name('logoutFormPage');

Route::get('/logsess', 'App\Http\Controllers\SessionController@deleteSession')->name('lgout');

Route::get('/subject/{id}', 'App\Http\Controllers\TeachController@getTeach')->name('subjectUser');
